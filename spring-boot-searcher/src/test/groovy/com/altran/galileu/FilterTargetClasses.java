...
package com.altran.galileu;

import com.openpojo.reflection.PojoClass;
import com.openpojo.reflection.PojoClassFilter;
import java.util.Locale;

public class FilterTargetClasses implements PojoClassFilter {
  public boolean include(PojoClass pojoClass) {
    return !(pojoClass.getName().contains(".Q") || pojoClass.getSourcePath().toLowerCase(Locale.ROOT).contains("test"));
  }
}
